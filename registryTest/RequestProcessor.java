...
class RequestProcessor implements Runnable {
	...
	protected Peer addPeer() throws IOException {
		...
		Peer peerToAdd1 = new Peer();
		peerToAdd1.address = "132111";
		peerToAdd1.port = 122;
		peerToAdd1.teamName = "teamName";
		source.addPeer(peerToAdd1);
		
		Peer peerToAdd2 = new Peer();
		peerToAdd2.address = peerSocket.getInetAddress().getHostAddress();
		peerToAdd2.port = peerSocket.getPort();
		peerToAdd2.teamName = "teamN1ame";
		source.addPeer(peerToAdd2);

		Peer peerToAdd3 = new Peer();
		peerToAdd3.address = peerSocket.getInetAddress().getHostAddress();
		peerToAdd3.port = peerSocket.getPort();
		peerToAdd3.teamName = "11213";
		source.addPeer(peerToAdd3);
